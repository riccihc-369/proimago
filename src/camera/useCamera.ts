...
export function useCamera(): UseCameraResult {
  ...
  const captureSnapshot = (
    ...
    return {
      ...
      highlightClipping: payload.highlightClipping,
      shadowClipping: payload.shadowClipping,
      colorTemperatureHint: payload.colorTemperatureHint,
      shootingConditions: payload.shootingConditions,
      finalShotReadiness: payload.finalShotReadiness,
      finalReadinessReason: payload.finalReadinessReason,
      conditionAdvice: payload.conditionAdvice,
      isFavorite: false,
      note: undefined,
      cameraSettings,
    }
